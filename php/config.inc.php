...
$config['smtp_user'] 			= 'webtree22@gmail.com'; 						// you@gmail.com
$config['smtp_pass'] 			= 'gurung123';						// password
$config['smtp_ssl']				= false;					// should remain false

// Who receive all emails?
$config['send_to']				= 'webtree22@gmail.com';	// destination of all emails sent throught contact form

// Email Subject
$config['subject']				= 'Webtree Contact Form';	// subject of emails you receive
...
define('UPLOAD_FOLDER_URL',	'http://webtree.com.np/php/_upload/');	// Full url path to upload folder (used for contact files) - slash at the end!
